...
class Stardog {
    ...
    ask(options) {
        return this._queryUpdate('query', Object.assign({
            accept: 'text/boolean'
        }, options));
    }
    ...
    async _request(url, options) {
        const data = (0, _clone2.default)(Object.assign({}, options, this._options));
        ...
        const resp = await (0, _requestPromiseNative2.default)(url, data);
    ...
    _get(url, options) {
        return this._request(url, Object.assign({}, options, {
            method: 'GET'
        }));
    }
